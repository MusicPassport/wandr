...
const About = () => {
    return (
        ...
        <div className="copy-box">
            ...
            <div classname="team">
                <h2>Meet the team</h2>
            <p>Sahira Bibi <a href="https://github.com/sahirabibi" alt="sahira's website"> on github </a> </p>
            <p>Shelby Reese <a href="https://github.com/shelbyreese47" alt="shelby's website"> on github </a></p>
            <p>Drew Mclean <a href="https://github.com/itsreallydrew" alt="drew's website"> on github </a></p>
            <p>Ben Papac <a href="https://github.com/benpapac" alt="ben's website"> on github </a></p>
            </div>
        </div>
        </section>
    );
